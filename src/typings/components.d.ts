...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    MyIcon: typeof import('./../components/next-drag-fab/plugin/my-icon/my-icon.vue')['default']
    NewsListItem: typeof import('./../components/common/NewsListItem.vue')['default']
    NextDragFab: typeof import('./../components/next-drag-fab/next-drag-fab.vue')['default']
